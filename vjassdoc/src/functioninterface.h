...
{
	public:
		FunctionInterface(const std::string &identifier, class SourceFile *sourceFile, unsigned int line, class DocComment *docComment, class Library *library, class Scope *scope, bool isPrivate, std::list<std::string> *parameterTypeExpressions, std::list<std::string> *parameters, const std::string &returnTypeExpression);
...
inline std::list<std::string>* FunctionInterface::parameterTypeExpressions() const
{
	return this->m_parameterTypeExpressions;
}
