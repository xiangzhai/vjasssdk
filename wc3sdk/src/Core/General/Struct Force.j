library AStructCoreGeneralForce requires AStructCoreGeneralVector
	...
	struct AForce
		...
		*/
		...
		/**
		* Adds all units of force @param whichForce to the force.
		* @param destroy If this value is true force @param whichForce will be destroyed after it has been added.
		* @param clear If this value is true force @param whichForce will be cleared after it has been added. This value has no effect if @param destroy is already true. If both parameters are false force @param whichForce won't change. Unfortunately the method has to check all players (limited Warcraft 3 natives).
		*/
