library StructTalksTalkTellborn requires Asl, Quests
	...
	private function buttonAction0 takes AInfo info returns nothing
		...
		call speech(info, true, tr("STRING_0"), null)
		call speech(info, false, tr("STRING_1"), null)
		call speech(info, true, tr("STRING_2"), null)
		...
		if (true) then //Fulco hats erzählt
			call speech(info, false, tr("STRING_6"), null)
			call speech(info, true, tr("STRING_7"), null)
		else
			call speech(info, false, tr("STRING_8"), null)
			call speech(info, true, tr("STRING_9"), null)
	...
	private function buttonAction1 takes AInfo info returns nothing
		call speech(info, false, tr("STRING_12"), null)
		call speech(info, true, tr("STRING_13"), null)
	...
	private function buttonAction2 takes AInfo info returns nothing
		call speech(info, false, tr("STRING_16"), null)
		call speech(info, true, tr("STRING_17"), null)
	...
	private function buttonAction3 takes AInfo info returns nothing
		call speech(info, false, tr("STRING_20"), null)
		call speech(info, true, tr("STRING_21"), null)
	...
	private function buttonAction4 takes AInfo info returns nothing
		...
		local unit characterUnit = info.talk().character().unit()
		call speech(info, false, tr("STRING_23"), null)
		call SetUnitAnimation(npc, "Spell")
		call ResetUnitAnimation(npc)
		call speech(info, true, tr("STRING_24"), null)
	...
	private function buttonAction1_0 takes AInfo info returns nothing
		...
		call speech(info, false, tr("STRING_25"), null)
		call speech(info, true, tr("STRING_26"), null)
	...
	private function buttonAction1_1 takes AInfo info returns nothing
		call speech(info, false, tr("STRING_27"), null)
		call speech(info, true, tr("STRING_28"), null)
		call info.talk().showStartPage()
	endfunction
	...
	struct TalkTellborn extends ATalk
		...
		public static method create takes nothing returns thistype
			...
			//start page
			call this.addInfo(false, false, 0, buttonAction0, tr("STRING_29")) //0
			call this.addInfo(false, false, buttonCondition1, buttonAction1, tr("STRING_30")) //1
			call this.addInfo(false, false, buttonCondition2, buttonAction2, tr("STRING_31")) //2
			call this.addInfo(false, false, 0, buttonAction3, tr("STRING_32")) //3
			call this.addInfo(true, false, buttonCondition4, buttonAction4, tr("STRING_33")) //4
			call this.addExitButton() //5
			
			//info 1
			call this.addInfo(false, false, 0, buttonAction1_0, tr("STRING_34")) //6
			call this.addInfo(false, false, 0, buttonAction1_1, tr("STRING_35")) //7
