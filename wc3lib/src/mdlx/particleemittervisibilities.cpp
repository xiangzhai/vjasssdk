...
ParticleEmitterVisibilities::ParticleEmitterVisibilities(class ParticleEmitter *particleEmitter) : MdlxAlphas(particleEmitter->particleEmitters()->mdlx(), "KPEV"), m_particleEmitter(particleEmitter)
{
}
