...
class MdlxScalings : public MdlxAnimatedProperties
{
	...
	protected:
		MdlxScalings(class Mdlx *mdlx, const byte mdxIdentifier[MdxBlock::mdxIdentifierSize]);
...
{
	return *reinterpret_cast<const std::list<class MdlxScaling*>*>(&this->properties());
}
