...
#ifndef VJASSDOC_INTERFACE_H
#define VJASSDOC_INTERFACE_H
...
{
	public:
		Interface(const std::string &identifier, class SourceFile *sourceFile, unsigned int line, class DocComment *docComment, class Library *library, class Scope *scope);
